            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-box">
                        ...
                        <p class="sub-header">
                            Work orders which are currenlty outside for washing
                        </p>
                        ...
                        <ul class="sortable-list taskList list-unstyled" id="upcoming">
                            ...
                            <li id="{{ $item['id'] }}">
                                ...
                                <h4 class="mt-0">Qty .: {{ $item['finQty'] }}</h4>
                                <h4 class="mt-0">Process .:<span class="badge badge-secondary">Washing</span></h4>
                    ...
                    <div class="card-box">
                        ...
                        <ul class="sortable-list taskList list-unstyled" id="upcoming">
                            ...
                            <li id="{{ $item['id'] }}">
                                <h3 class="mt-0">WO No.: {{ $item['id'] }}</h3>
                                <h4 class="mt-0">Qty.: {{ $item['finQty'] }}</h4>
                                <h4 class="mt-0">Finish Good Qty.: {{ $item['fg'] }}</h4>
                                <div class="clearfix"></div>
                                <div class="row">
                                    <div class="col">
                                        <p class="font-13 mt-2 mb-0"><i class="mdi mdi-calendar"></i>
